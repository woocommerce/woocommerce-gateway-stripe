...
- **CRITICAL:** Any reply you draft for the user to post to GitHub (issue/PR comments, review thread replies) or Linear MUST end with an AI-assistance disclosure on its own line, separated by a blank line:

  > Drafted with assistance from Claude Code; reviewed and posted by me.

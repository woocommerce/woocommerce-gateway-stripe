	...
	public function provide_test_payment_icons() {
		...
		return [
			'default'                => [
				...
				'filter'                 => null,
				'expected'               => [
					'us_bank_account' => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/bank-debit.svg" class="stripe-ach-icon stripe-icon" alt="ACH" />',
					'acss_debit'      => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/bank-debit.svg" class="stripe-ach-icon stripe-icon" alt="Pre-Authorized Debit" />',
					'alipay'          => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/alipay.svg" class="stripe-alipay-icon stripe-icon" alt="Alipay" />',
					'au_becs_debit'   => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/bank-debit.svg" class="stripe-ach-icon stripe-icon" alt="BECS Direct Debit" />',
					'blik'            => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/blik.svg" class="stripe-blik-icon stripe-icon" alt="BLIK" />',
					'wechat_pay'      => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/wechat.svg" class="stripe-wechat-icon stripe-icon" alt="Wechat Pay" />',
					'bancontact'      => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/bancontact.svg" class="stripe-bancontact-icon stripe-icon" alt="Bancontact" />',
					'ideal'           => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/ideal.svg" class="stripe-ideal-icon stripe-icon" alt="iDEAL" />',
					'p24'             => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/p24.svg" class="stripe-p24-icon stripe-icon" alt="P24" />',
					'giropay'         => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/giropay.svg" class="stripe-giropay-icon stripe-icon" alt="giropay" />',
					'klarna'          => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/klarna.svg" class="stripe-klarna-icon stripe-icon" alt="Klarna" />',
					'affirm'          => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/affirm.svg" class="stripe-affirm-icon stripe-icon" alt="Affirm" />',
					'eps'             => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/eps.svg" class="stripe-eps-icon stripe-icon" alt="EPS" />',
					'multibanco'      => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/multibanco.svg" class="stripe-multibanco-icon stripe-icon" alt="Multibanco" />',
					'sofort'          => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/sofort.svg" class="stripe-sofort-icon stripe-icon" alt="Sofort" />',
					'sepa'            => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/sepa.svg" class="stripe-sepa-icon stripe-icon" alt="SEPA" />',
					'boleto'          => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/boleto.svg" class="stripe-boleto-icon stripe-icon" alt="Boleto" />',
					'oxxo'            => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/oxxo.svg" class="stripe-oxxo-icon stripe-icon" alt="OXXO" />',
					'cards'           => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/cards.svg" class="stripe-cards-icon stripe-icon" alt="Credit / Debit Card" />',
					'cashapp'         => '<img src="http://example.org/wp-content/plugins/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/assets/images/cashapp.svg" class="stripe-cashapp-icon stripe-icon" alt="Cash App Pay" />',
				],
			],

	...
	public function test_renewal_successful() {
		...
		$pre_http_request_response_callback = function( $preempt, $request_args, $url ) use (
			...
			return array(
				...
				'body'     => file_get_contents( '/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/tests/phpunit/dummy-data/subscription_renewal_response_success.json' ),
				'response' => array(
					'code'    => 200,
					'message' => 'OK',
				),
	...
	public function test_renewal_authorization_required() {
		...
		$pre_http_request_response_callback = function( $preempt, $request_args, $url ) use (
			...
			return array(
				'headers'  => array(),
				// Too bad we aren't dynamically setting things 'cus_123abc' when using this file.
				'body'     => file_get_contents( '/var/www/html/wp-content/plugins/woocommerce-gateway-stripe/tests/phpunit/dummy-data/subscription_renewal_response_authentication_required.json' ),
				'response' => array(
					'code'    => 402,

...
class WC_Stripe_Subscriptions_Repairer_Legacy_SEPA_Tokens_Test extends WP_UnitTestCase {
	...
	public function set_up() {
		...
		WC_Stripe_Payment_Gateway::update_stored_settings( [ 'test_connection_type' => 'connect' ] );
	}
	...
	public function test_updater_gets_scheduled_on_right_conditions() {
		WC_Stripe_Payment_Gateway::update_stored_settings( [ 'upe_checkout_experience_enabled' => 'yes' ] );

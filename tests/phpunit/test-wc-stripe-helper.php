...
class WC_Stripe_Helper_Test extends WP_UnitTestCase {
	...
	/**
	 * Test for `update_main_stripe_settings`, `get_main_stripe_settings` and `delete_main_stripe_settings`.
	 *
	 * @return void
	 */
	public function test_handle_main_stripe_settings() {
		WC_Stripe_Helper::update_main_stripe_settings( [ 'test' => 'test' ] );
		$current_settings = WC_Stripe_Helper::get_main_stripe_settings();

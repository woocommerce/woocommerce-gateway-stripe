 ...
 */
class WC_Stripe_UPE_Payment_Method_Eps_Test extends WC_Stripe_UPE_Payment_Method_Test_Case {
	/**
	...
	public function test_is_available_for_account_country( string $account_country, bool $expected_result ): void {
		$this->run_is_available_for_account_country_test( WC_Stripe_UPE_Payment_Method_Eps::class, $account_country, $expected_result );
	}

...
/**
 * These tests make assertions against class WC_Stripe_UPE_Payment_Method_Bancontact.
 */
class WC_Stripe_UPE_Payment_Method_Bancontact_Test extends WC_Stripe_UPE_Payment_Method_Test_Case {
	/**
	 * Test that {@see WC_Stripe_UPE_Payment_Method_Bancontact::is_available_for_account_country()}
	 * behaves as expected.
	 *
	...
	public function test_is_available_for_account_country( string $account_country, bool $expected_result ): void {
		$this->run_is_available_for_account_country_test( WC_Stripe_UPE_Payment_Method_Bancontact::class, $account_country, $expected_result );
	}

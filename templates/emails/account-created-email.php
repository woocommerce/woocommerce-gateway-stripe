...
echo sprintf( __( 'Login Name: %s', 'woocommerce-gateway-stripe' ), $user_email ) . "\n\n";

echo __( 'Click the link below to set your password and gain access to your account.', 'woocommerce-gateway-stripe' ) . "\n";

echo esc_url_raw( add_query_arg( array( 'action' => 'rp', 'key' => $password_reset_key, 'login' => rawurlencode( $username ) ), wp_login_url() ) ) . "\n\n";

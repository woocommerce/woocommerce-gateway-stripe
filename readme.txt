...
= 10.8.0 - xxxx-xx-xx =
* Fix - Add an order note and call action 'wc_stripe_deferred_orphaned_charge_detected' when a PaymentIntent succeeds for an order that was already paid via a different gateway

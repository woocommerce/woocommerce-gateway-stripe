...
* Update - Deprecate WC_Stripe_Helper::get_stripe_settings() and update_main_stripe_settings() in favor of WC_Stripe::read_settings_option() and write_settings_option()

...
You can set up your local development environment and run tests by [using Docker](https://raw.githubusercontent.com/woocommerce/woocommerce-gateway-stripe/trunk/docs/DOCKER.md).

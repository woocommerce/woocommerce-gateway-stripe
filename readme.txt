...
* Fix - Base Level 3 data on the payment method types in the Stripe request, and stop disabling Level 3 account-wide on rejections for unknown payment types

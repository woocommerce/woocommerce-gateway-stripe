...
* Fix - Prevent classic checkout from submitting an order without a payment method while the Stripe Payment Element is re-mounting after a checkout update (e.g. shipping or address change)

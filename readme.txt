...
* Update - Deprecate WC_Stripe_Helper::get_stripe_settings() and update_main_stripe_settings() in favor of the main Stripe gateway's get_settings() and update_settings()

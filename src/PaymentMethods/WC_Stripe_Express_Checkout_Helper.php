...
class WC_Stripe_Express_Checkout_Helper {
	...
	public function normalize_state( $data ) {
		...
		if ( 'HK' === $billing_country ) {
			include_once WC_STRIPE_PLUGIN_PATH . '/src/constants/class-wc-stripe-hong-kong-states.php';
	...
	public function get_normalized_state_from_pr_states( $state, $country ) {
		...
		include_once WC_STRIPE_PLUGIN_PATH . '/src/constants/class-wc-stripe-payment-request-button-states.php';

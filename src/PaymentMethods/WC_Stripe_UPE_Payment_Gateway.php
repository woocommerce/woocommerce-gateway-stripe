...
use WooCommerce\Stripe\WC_Stripe_Intent_Controller;
use WooCommerce\Stripe\WC_Stripe_Logger;
use WooCommerce\Stripe\WC_Stripe_Mode;
use WooCommerce\Stripe\WC_Stripe_Payment_Method_Configurations;
...
class WC_Stripe_UPE_Payment_Gateway extends WC_Gateway_Stripe {
	...
	public function init_form_fields() {
		$this->form_fields = require WC_STRIPE_PLUGIN_PATH . '/src/Admin/stripe-settings.php';

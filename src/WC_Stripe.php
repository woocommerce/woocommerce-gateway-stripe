...
namespace WooCommerce\Stripe;

use WooCommerce\Stripe\Abstracts\WC_Stripe_Payment_Gateway;
use WooCommerce\Stripe\Admin\WC_REST_Stripe_Account_Controller;
use WooCommerce\Stripe\Admin\WC_REST_Stripe_Account_Keys_Controller;
use WooCommerce\Stripe\Admin\WC_REST_Stripe_Connection_Tokens_Controller;
use WooCommerce\Stripe\Admin\WC_REST_Stripe_Locations_Controller;
use WooCommerce\Stripe\Admin\WC_REST_Stripe_Orders_Controller;
use WooCommerce\Stripe\Admin\WC_REST_Stripe_Settings_Controller;
use WooCommerce\Stripe\Admin\WC_REST_Stripe_Tokens_Controller;
use WooCommerce\Stripe\Admin\WC_Stripe_Amazon_Pay_Controller;
use WooCommerce\Stripe\Admin\WC_Stripe_Inbox_Notes;
use WooCommerce\Stripe\Admin\WC_Stripe_Payment_Gateways_Controller;
use WooCommerce\Stripe\Admin\WC_Stripe_Payment_Requests_Controller;
use WooCommerce\Stripe\Admin\WC_Stripe_Privacy;
use WooCommerce\Stripe\Admin\WC_Stripe_REST_UPE_Flag_Toggle_Controller;
use WooCommerce\Stripe\Admin\WC_Stripe_Settings_Controller;
use WooCommerce\Stripe\Admin\WC_Stripe_UPE_Compatibility_Controller;
use WooCommerce\Stripe\Compat\WC_Stripe_Email_Failed_Authentication_Retry;
use WooCommerce\Stripe\Compat\WC_Stripe_Email_Failed_Preorder_Authentication;
use WooCommerce\Stripe\Compat\WC_Stripe_Email_Failed_Renewal_Authentication;
use WooCommerce\Stripe\Connect\WC_Stripe_Connect;
use WooCommerce\Stripe\Connect\WC_Stripe_Connect_API;
use WooCommerce\Stripe\Connect\WC_Stripe_Connect_REST_Oauth_Connect_Controller;
use WooCommerce\Stripe\Connect\WC_Stripe_Connect_REST_Oauth_Init_Controller;
use WooCommerce\Stripe\Deprecated\WC_Stripe_Apple_Pay;
use WooCommerce\Stripe\Migrations\Allowed_Payment_Request_Button_Types_Update;
use WooCommerce\Stripe\Migrations\WC_Stripe_Subscriptions_Repairer_Legacy_SEPA_Tokens;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_Alipay;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_Bancontact;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_Boleto;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_Eps;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_Giropay;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_Ideal;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_Multibanco;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_Oxxo;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_P24;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_Sepa;
use WooCommerce\Stripe\PaymentMethods\WC_Gateway_Stripe_Sofort;
use WooCommerce\Stripe\PaymentMethods\WC_Stripe_Express_Checkout_Ajax_Handler;
use WooCommerce\Stripe\PaymentMethods\WC_Stripe_Express_Checkout_Element;
use WooCommerce\Stripe\PaymentMethods\WC_Stripe_Express_Checkout_Helper;
use WooCommerce\Stripe\PaymentMethods\WC_Stripe_Payment_Request;
use WooCommerce\Stripe\PaymentMethods\WC_Stripe_UPE_Payment_Gateway;
use WooCommerce\Stripe\PaymentMethods\WC_Stripe_UPE_Payment_Method_Link;
...
class WC_Stripe {
	...
	public function init() {
		...
		$this->account                       = new WC_Stripe_Account( $this->connect, WC_Stripe_API::class );
	...
	public function woocommerce_gateway_stripe_woocommerce_block_support() {

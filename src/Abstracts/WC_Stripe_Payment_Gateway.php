...
use WooCommerce\Stripe\Compat\WC_Stripe_Pre_Orders_Trait;
use WooCommerce\Stripe\Compat\WC_Stripe_Subscriptions_Trait;
...
use WooCommerce\Stripe\WC_Stripe_Webhook_State;

...
abstract class WC_Stripe_Payment_Gateway extends WC_Payment_Gateway_CC {
	...
	public function payment_icons() {
		$icon_list = [
			...
			WC_Stripe_Payment_Methods::BANK_TRANSFER => '<img src="' . WC_STRIPE_PLUGIN_URL . '/assets/images/bank-debit.svg" class="stripe-ach-icon stripe-icon" alt="' . __( 'Bank Transfer', 'woocommerce-gateway-stripe' ) . '" />',

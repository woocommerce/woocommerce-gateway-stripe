...
class WC_Stripe_UPE_Payment_Method_Amazon_Pay extends WC_Stripe_UPE_Payment_Method {
	...
	public function __construct() {
		...
		$this->is_reusable = false; // TODO Check if Amazon Pay is reusable
		$this->label       = __( 'Amazon Pay', 'woocommerce-gateway-stripe' );
		$this->description = __(
			'Amazon Pay lets your customers check out the same way as on Amazon.com', // TODO
	...
	public static function is_amazon_pay_enabled() {
		// Assume Amazon Pay is disabled if UPE is disabled.
	...
	/**
	 * Filters the gateway title to reflect Amazon Pay as the payment method.
	 */

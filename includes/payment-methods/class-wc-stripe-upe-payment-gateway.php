...
class WC_Stripe_UPE_Payment_Gateway extends WC_Stripe_Payment_Gateway {
	...
	public function process_payment( $order_id, $retry = true, $force_save_source = false, $previous_error = false, $use_order_source = false ) {
		...
		$checkout_session_id   = isset( $_POST['wc-stripe-checkout-session-id'] ) ? wc_clean( wp_unslash( $_POST['wc-stripe-checkout-session-id'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing
		$order                 = wc_get_order( $order_id );

...
class WC_Gateway_Stripe_Eps extends WC_Stripe_Payment_Gateway {
	...
	public function check_environment() {
		...
		$show_notice = get_option( 'wc_stripe_show_eps_notice' );
		...
		if ( $environment_warning ) {
			$this->add_admin_notice( 'eps', 'notice notice-error', $environment_warning );
		}
	...
	public function get_environment_warning() {
		if ( 'yes' === $this->enabled && ! in_array( get_woocommerce_currency(), $this->get_supported_currency() ) ) {
			$message = __( 'EPS is enabled - it requires store currency to be set to Euros.', 'woocommerce-gateway-stripe' );

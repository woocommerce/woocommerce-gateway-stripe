...
class WC_Stripe_Express_Checkout_Helper {
	...
	public function get_button_type() {
		return $this->stripe_settings['express_checkout_button_type'] ?? $this->stripe_settings['payment_request_button_type'] ?? 'default';
	}
	...
	public function get_button_theme() {
		return $this->stripe_settings['express_checkout_button_theme'] ?? $this->stripe_settings['payment_request_button_theme'] ?? 'dark';
	}
	...
	public function get_button_height() {
		$height = $this->stripe_settings['express_checkout_button_size'] ?? $this->stripe_settings['payment_request_button_size'] ?? 'default';
		if ( 'small' === $height ) {
			return '40';
		}
	...
	public function get_button_locations() {
		...
		return $this->stripe_settings['express_checkout_button_locations'] ?? $this->stripe_settings['payment_request_button_locations'];
	}
	...
	public function is_express_checkout_enabled() {
		return 'yes' === ( $this->stripe_settings['express_checkout'] ?? $this->stripe_settings['payment_request'] ?? 'no' );
	}

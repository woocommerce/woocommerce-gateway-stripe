...
class WC_Stripe_Express_Checkout_Helper {
	...
	public function get_button_type() {
		return $this->stripe_settings['express_checkout_button_type'] ?? 'default';
	}
	...
	public function get_button_theme() {
		return $this->stripe_settings['express_checkout_button_theme'] ?? 'dark';
	}
	...
	public function get_button_height() {
		$height = $this->stripe_settings['express_checkout_button_size'] ?? 'default';
		if ( 'small' === $height ) {
			return '40';
		}

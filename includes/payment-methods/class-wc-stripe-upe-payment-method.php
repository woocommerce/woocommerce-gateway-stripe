...
abstract class WC_Stripe_UPE_Payment_Method extends WC_Payment_Gateway {
	...
	public function is_available() {
		...
		if ( $this->oc_enabled && $main_stripe_gateway->is_valid_optimized_checkout_page() && WC_Stripe_Helper::is_stripe_gateway_first_in_available_list( WC_Stripe_UPE_Payment_Gateway::ID ) ) {

...
class WC_Stripe_Autoloader {
	...
	private static function get_classmap() {
		return [
			...
			'Controller\WC_REST_Stripe_Account_Controller' => __DIR__ . '/Admin/Controller/WC_REST_Stripe_Account_Controller.php',
			'Controller\WC_REST_Stripe_Account_Keys_Controller' => __DIR__ . '/Admin/Controller/WC_REST_Stripe_Account_Keys_Controller.php',
			'Controller\WC_REST_Stripe_Connection_Tokens_Controller' => __DIR__ . '/Admin/Controller/WC_REST_Stripe_Connection_Tokens_Controller.php',
			'Controller\WC_REST_Stripe_Locations_Controller' => __DIR__ . '/Admin/WC_REST_Stripe_Locations_Controller.php',
			'Controller\WC_REST_Stripe_Orders_Controller'  => __DIR__ . '/Admin/Controller/WC_REST_Stripe_Orders_Controller.php',
			'Controller\WC_REST_Stripe_Settings_Controller' => __DIR__ . '/Admin/WC_REST_Stripe_Settings_Controller.php',
			'Controller\WC_REST_Stripe_Tokens_Controller'  => __DIR__ . '/Admin/Controller/WC_REST_Stripe_Tokens_Controller.php',
			...
			'wc_stripe_admin_upe_compatibility_controller' => __DIR__ . '/Admin/Controller/WC_Stripe_UPE_Compatibility_Controller.php',
			'Controller\WC_Stripe_Amazon_Pay_Controller'   => __DIR__ . '/Admin/Controller/WC_Stripe_Amazon_Pay_Controller.php',
			...
			'Controller\WC_Stripe_Payment_Gateways_Controller' => __DIR__ . '/Admin/Controller/WC_Stripe_Payment_Gateways_Controller.php',
			...
			'Controller\WC_Stripe_Payment_Requests_Controller' => __DIR__ . '/Admin/Controller/WC_Stripe_Payment_Requests_Controller.php',
			...
			'Controller\WC_Stripe_REST_Base_Controller'    => __DIR__ . '/Admin/Controller/WC_Stripe_REST_Base_Controller.php',
			'Controller\WC_Stripe_REST_UPE_Flag_Toggle_Controller' => __DIR__ . '/Admin/Controller/WC_Stripe_REST_UPE_Flag_Toggle_Controller.php',
			'Settings\WC_Stripe_Settings_Controller'       => __DIR__ . '/Admin/Controller/WC_Stripe_Settings_Controller.php',
			...
			'Controller\WC_Stripe_UPE_Compatibility_Controller' => __DIR__ . '/Admin/Controller/WC_Stripe_UPE_Compatibility_Controller.php',

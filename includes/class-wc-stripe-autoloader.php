...
class WC_Stripe_Autoloader {
	...
	private static function get_classmap(): array {
		return [
			...
			'sepa_tokens_for_other_methods_settings_update'         => __DIR__ . '/migrations/class-sepa-tokens-for-other-methods-settings-update.php',
			...
			'wc_payment_token_klarna'                               => __DIR__ . '/payment-tokens/class-wc-stripe-klarna-payment-token.php',
			...
			'wc_stripe_database_cache'                              => __DIR__ . '/class-wc-stripe-database-cache.php',
			'wc_stripe_database_cache_prefetch'                     => __DIR__ . '/class-wc-stripe-database-cache-prefetch.php',
			...
			'wc_stripe_email_admin_failed_refund'                   => __DIR__ . '/compat/class-wc-stripe-email-admin-failed-refund.php',
			'wc_stripe_email_customer_failed_refund'                => __DIR__ . '/compat/class-wc-stripe-email-customer-failed-refund.php',
			...
			'wc_stripe_express_checkout_custom_fields'              => __DIR__ . '/payment-methods/class-wc-stripe-express-checkout-custom-fields.php',
			...
			'wc_stripe_checkout_sessions_controller'                => __DIR__ . '/class-wc-stripe-checkout-sessions-controller.php',
			...
			'wc_stripe_express_checkout'                            => __DIR__ . '/payment-methods/class-wc-stripe-express-checkout.php',
			'wc_stripe_express_checkout_button_states'              => __DIR__ . '/constants/class-wc-stripe-express-checkout-button-states.php',
			'wc_stripe_express_checkout_controller'                 => __DIR__ . '/admin/class-wc-stripe-express-checkout-controller.php',
			...
			'wc_stripe_rest_oc_setting_toggle_controller'           => __DIR__ . '/admin/class-wc-stripe-rest-oc-setting-toggle-controller.php',
			...
			'wc_stripe_upe_payment_method_oc'                       => __DIR__ . '/payment-methods/class-wc-stripe-upe-payment-method-oc.php',
			'wc_stripe_upe_stripelink_note'                         => __DIR__ . '/notes/class-wc-stripe-upe-stripelink-note.php',
			'wc_stripe_bnpl_promotion_note'                         => __DIR__ . '/notes/class-wc-stripe-bnpl-promotion-note.php',
			'wc_stripe_oc_promotion_note'                           => __DIR__ . '/notes/class-wc-stripe-oc-promotion-note.php',

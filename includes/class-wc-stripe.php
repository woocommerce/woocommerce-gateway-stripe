...
class WC_Stripe {
	...
	public function add_emails( $email_classes ) {
		...
		$email_classes['WC_Stripe_Email_Failed_Authentication_Retry']    = new WC_Stripe_Email_Failed_Authentication_Retry(); // $email_classes parameter removed. This class does not accept it.

...
return apply_filters( 'wc_stripe_settings',
	array(
		...
		'stripe_disable_remember_me' => array(
			'title'       => __( 'Stripe Remember Me', 'woocommerce-gateway-stripe' ),
			'label'       => __( 'Disable Stripe Checkout Remember Me Option', 'woocommerce-gateway-stripe' ),
			'type'        => 'checkbox',
			'description' => __( 'If disabled, the "Remember Me" option will not show on the checkout modal.', 'woocommerce-gateway-stripe' ),
			'default'     => 'no',
			'desc_tip'    => true,
		),

...
class WC_Stripe_Privacy extends WC_Abstract_Privacy {
	...
	protected function maybe_handle_subscription( $order ) {
		...
		foreach ( $renewal_orders as $renewal_order ) {
			...
			$this->delete_stripe_refund_ids_from_refunds( $renewal_order );
		}
	...
	protected function maybe_handle_order( $order ) {
		...
		$refunds_with_stripe_id = $this->get_refunds_with_stripe_refund_ids( $order );
		...
		$this->delete_stripe_refund_ids_from_refunds( $order );
	 ...
	 */
	private function get_refunds_with_stripe_refund_ids( $order ) {
		$order_helper = WC_Stripe_Order_Helper::get_instance();
	 ...
	 * @return void
	 */
	private function delete_stripe_refund_ids_from_refunds( $order ) {
		$order_helper = WC_Stripe_Order_Helper::get_instance();

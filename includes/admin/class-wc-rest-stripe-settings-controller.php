...
class WC_REST_Stripe_Settings_Controller extends WC_Stripe_REST_Base_Controller {
	...
	public function get_settings() {
		...
		$express_payment_method_ids   = [ WC_Stripe_Payment_Methods::LINK, WC_Stripe_Payment_Methods::AMAZON_PAY ];
		...
		return new WP_REST_Response(
			[
				...
				'ordered_payment_method_ids'            => array_values( array_diff( $ordered_payment_method_ids, $express_payment_method_ids ) ), // exclude Link from this list as it is a express methods.

...
/**
 * Admin page for Link by Stripe Customize Express Checkouts.
 */
class WC_Stripe_Link_Controller {
	...
	public function admin_scripts() {
		...
		$script_asset_path = WC_STRIPE_PLUGIN_PATH . '/build/link-settings.asset.php';
		...
		wp_register_script(
			...
			plugins_url( 'build/link-settings.js', WC_STRIPE_MAIN_FILE ),
	...
	public function admin_options() {
		...
		echo '<div class="wrap"><div id="wc-stripe-link-settings-container"></div></div>';
	}
}

...
class WC_Stripe_Payment_Request_Button_States {
	...
	const STATES = [
		...
		// Ukraine.
		'UA' => [
			'UA-05' => [ 'Vinnytsia', 'Vinnytsia', NULL ],
			'UA-07' => [ 'Volyn', 'Volyn', NULL ],
			'UA-09' => [ 'Luhansk', 'Luhansk', NULL ],
			'UA-12' => [ 'Dnipropetrovsk', 'Dnipropetrovsk', NULL ],
			'UA-14' => [ 'Donetsk', 'Donetsk', NULL ],
			'UA-18' => [ 'Zhytomyr', 'Zhytomyr', NULL ],
			'UA-21' => [ 'Zakarpattia', 'Zakarpattia', NULL ],
			'UA-23' => [ 'Zaporizhzhia', 'Zaporizhzhia', NULL ],
			'UA-26' => [ 'Ivano-Frankivsk', 'Ivano-Frankivsk', NULL ],
			'UA-30' => [ 'Kyiv', 'Kyiv', NULL ],
			'UA-32' => [ 'Kyivska', 'Kyivska', NULL ],
			'UA-35' => [ 'Kirovohrad', 'Kirovohrad', NULL ],
			'UA-40' => [ 'Sevastopol', 'Sevastopol', NULL ],
			'UA-43' => [ 'Crimea', 'Crimea', NULL ],
			'UA-46' => [ 'Lviv', 'Lviv', NULL ],
			'UA-48' => [ 'Mykolaiv', 'Mykolaiv', NULL ],
			'UA-51' => [ 'Odesa', 'Odesa', NULL ],
			'UA-53' => [ 'Poltava', 'Poltava', NULL ],
			'UA-56' => [ 'Rivne', 'Rivne', NULL ],
			'UA-59' => [ 'Sumy', 'Sumy', NULL ],
			'UA-61' => [ 'Ternopil', 'Ternopil', NULL ],
			'UA-63' => [ 'Kharkiv', 'Kharkiv', NULL ],
			'UA-65' => [ 'Kherson', 'Kherson', NULL ],
			'UA-68' => [ 'Khmelnytskyi', 'Khmelnytskyi', NULL ],
			'UA-71' => [ 'Cherkasy', 'Cherkasy', NULL ],
			'UA-74' => [ 'Chernihiv', 'Chernihiv', NULL ],
			'UA-77' => [ 'Chernivtsi', 'Chernivtsi', NULL ],
		],
		// Uganda.
		'UG' => [],

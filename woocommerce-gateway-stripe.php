	...
	if ( ! isset( $plugin ) ) {
		...
		class WC_Stripe {
			...
			public function init() {
				...
				require_once dirname( __FILE__ ) . '/includes/payment-methods/class-wc-stripe-upe-payment-method-apple-pay.php';
				...
				require_once dirname( __FILE__ ) . '/includes/payment-methods/class-wc-stripe-upe-payment-method-google-pay.php';

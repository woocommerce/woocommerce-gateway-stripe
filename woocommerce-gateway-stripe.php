...
function woocommerce_gateway_stripe() {
	...
	if ( ! isset( $plugin ) ) {
		...
		} elseif ( file_exists( WC_STRIPE_PLUGIN_PATH . '/includes/class-wc-stripe-autoloader.php' ) ) {
			// Initialize our custom autoloader as a fallback.
			require_once WC_STRIPE_PLUGIN_PATH . '/includes/class-wc-stripe-autoloader.php';

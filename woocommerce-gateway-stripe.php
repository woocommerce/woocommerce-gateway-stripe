		...
		class WC_Stripe {
			...
			public function register_routes() {
				...
				if ( WC_Stripe_Feature_Flags::is_upe_preview_enabled() ) {
					...
					require_once WC_STRIPE_PLUGIN_PATH . '/includes/admin/class-wc-rest-gateway-settings-controller.php';
					...
					$settings_controller = new WC_REST_Gateway_Settings_Controller();
					$settings_controller->register_routes();
				}
			}

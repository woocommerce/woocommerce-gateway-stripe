...
use WooCommerce\Stripe\Notes\WC_Stripe_UPE_Availability_Note;
use WooCommerce\Stripe\Notes\WC_Stripe_UPE_StripeLink_Note;
...
add_action( 'plugins_loaded', __NAMESPACE__ . '\woocommerce_gateway_stripe_init' );
...
add_action( 'woocommerce_blocks_loaded', __NAMESPACE__ . '\woocommerce_gateway_stripe_woocommerce_block_support' );
	...
	if ( class_exists( 'Automattic\WooCommerce\Blocks\Payments\Integrations\AbstractPaymentMethodType' ) ) {
		...
		add_action(
			...
			function ( PaymentMethodRegistry $payment_method_registry ) {
				...
				if ( ! class_exists( WC_Stripe_Payment_Request::class ) || ! class_exists( WC_Stripe_Express_Checkout_Element::class ) ) {
					return;
				}
				...
				$container->register(
					...
					function () {
						if ( class_exists( WC_Stripe::class ) ) {

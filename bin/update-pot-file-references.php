...
function load_js_transpiling_source_maps(): array {
	...
	if ( empty( $mappings ) ) {
		echo "[ERROR] Unable to load JS transpiling mappings from 'build/*.js.map' files. Make sure the JS assets compilation was successful (e.g. pnpm run build:webpack).\n";
		die();
	}

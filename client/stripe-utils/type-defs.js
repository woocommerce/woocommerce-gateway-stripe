 ...
 *                                               available.
 * @property {function():void}    show           Shows the browser's payment
 *                                               interface (called automatically
 *                                               if payment request button in
 *                                               use)
 * @property {function():void}    update         Used to update a PaymentRequest
 *                                               object.
 * @property {function():void}    on             For registering callbacks on
 ...
 *                                             elements.
 * @property {function(boolean):void} onActive A callback for setting whether an
 *                                             element is active or not. "Active"
 *                                             means it's not empty.
 * @property {string}                 error    Any error message from the stripe
 *                                             element.
 * @property {function(string):void}  setError A callback for setting an error
 *                                             message.
 */

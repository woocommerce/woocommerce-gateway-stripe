...
jQuery( function ( $ ) {
	...
	const wcStripeECE = {
		...
		attachProductPageEventListeners: () => {
			...
			// themselves. observeQuantitySteppers only matches the blockified
			// form (simple products render it too), so unlike the variation
			// observer above it needs no template check here.

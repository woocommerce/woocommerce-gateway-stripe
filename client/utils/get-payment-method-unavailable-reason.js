 ...
 * @param {boolean}     [context.isAdaptivePricingEnabled] When true, store currency mismatch does not block (Adaptive Pricing can settle in shopper-presented currency).

				...
				<CardColumn>
					...
					<p>
						...
						{ interpolateComponents( {
							mixedString: __(
								"Optimize your checkout for more sales by dynamically displaying the most relevant payment methods for each customer. {{docLink}}Learn more{{/docLink}} about Stripe's Optimized Checkout Suite.",
								'woocommerce-gateway-stripe'
							),
							components: {
								docLink: (

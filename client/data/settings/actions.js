...
export function* saveSettings() {
	...
	try {
		...
		error = e;
		// Append the REST error detail (e.g. a Payment Method Configuration
		// update rejected by Stripe) after the generic message so the merchant
		// sees both the outcome and the reason.
